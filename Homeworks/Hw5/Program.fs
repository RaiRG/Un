...
module Main =
    ...
    let main _ =
        ...
        let serviceCalculating calculate operator x y  =
                Async.RunSynchronously(calculate operator x y)
                        ...
                        |true -> let y = Console.ReadLine()
                                 ...
                                 match checkY with
                                        ...
                                        |true -> let z = Convert.ToDouble(x)
                                                 let result = serviceCalculating Calculator.calculate operator x y
                                                 print result
        0